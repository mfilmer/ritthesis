...
% Also, the bibliography won't show up in the toc unless you create a
% phantom section and add a toc entry. Use a \cleardoublepage first or the toc
% entry will usually point to the wrong page.
\cleardoublepage
\phantomsection
