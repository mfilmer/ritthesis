...
% microsys
% When using this option, only the \specialcommittee macro should be used, and
% \advisor and \committee should not be used as these don't provide all the
% required options for the microsystems signature sheet.
...
\centering
\includegraphics[width=\linewidth]{kgcoelogohoriz}
